...
# here, without populate_existing(), we haven't expired the collections so we don't 
# expect them to reorder themselves.  crash expected. Compare populate_existing_subquery_orderby.py
